 ...
 */
public interface FuturesForCSubscriptionClient extends SubscriptionClient {
     ...
     */
    static FuturesForCSubscriptionClient create() {
     ...
     * @return The instance of synchronous client.
     */
    static FuturesForCSubscriptionClient create(SubscriptionOptions subscriptionOptions) {
        return BinanceApiInternalFactory.getInstance().createFuturesForCSubClient(subscriptionOptions);
    }
