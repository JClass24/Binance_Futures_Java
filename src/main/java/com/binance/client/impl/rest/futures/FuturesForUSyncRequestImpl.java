...
public class FuturesForUSyncRequestImpl implements FuturesForUSyncRequestClient {

    private final FuturesForURestApiRequestImpl requestImpl;

    public FuturesForUSyncRequestImpl(FuturesForURestApiRequestImpl requestImpl) {
    ...
    @Override
    public FuturesOrder postOrder(String symbol, OrderSide side, PositionSide positionSide, OrderType orderType,
